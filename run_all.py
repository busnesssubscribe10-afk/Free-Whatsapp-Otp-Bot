...
def cleanup_old_instances():
    """পূর্বে চালু থাকা পুরনো প্রসেস ক্লিয়ার করা"""
    if sys.platform != "win32":
        return
    try:
        curr_pid = os.getpid()
        ps_cmd = (
            ...
            f"($_.CommandLine -like '*bot.py*' -or $_.CommandLine -like '*userbot_forwarder.py*' -or $_.CommandLine -like '*ivasms_fetcher.py*') "
